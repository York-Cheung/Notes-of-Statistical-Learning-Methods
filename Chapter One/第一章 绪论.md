...
| :-----------: | :--------------------------------------: | :------------------------------------------------: | :-----------------: |
| Least squared | $L(Y,f(X)) = \tfrac{1}{2} (Y - f(X))^2$  |     ![Attachment.jpeg](assets/Attachment.jpeg)     |  Linear regression  |
|   Logistic    |         $log(1 + exp(−Y*f(X)))$          | ![Attachment.jpeg](assets/Attachment-4047124.jpeg) | Logistic regression |
|     Hinge     |           $max(0,1 − Y*f(X))$            | ![Attachment.jpeg](assets/Attachment-4047133.jpeg) |         SVM         |
| Cross-entropy | $− Y*log(f(X)) + (1 − Y)* log(1 − f(X))$ | ![Attachment.jpeg](assets/Attachment-4047138.jpeg) |   Neural Network    |
